...
input("Roll the dice for the monster's weapon (Press enter)")
magicRoll = random.choice(["Fire Magic", "Time Freeze", "Super Hearing"])

m_combat_strength = min(6, (m_combat_strength + magic[magicRoll]))
print("The monster's magic is " + magicRoll)
...
print("You've found a loot bag!")
input("Roll for the first item (Press Enter)")
lootpick = random.choice(range(0, len(loot_options)))
loot = loot_options.pop(lootpick)
belt.append(loot)
print("Items in your belt: ")
for items in belt:
    print(items)
...
print("Your belt is being sorted in alphabetical order")
belt.sort()
print("Items in your belt: ")
for items in belt:
    print(items)
...
print("You use the first item in your belt")
nextitem = belt.pop(0)
print(nextitem)

if nextitem in good_loot_options:
    health_points = min(6, (health_points + 2))
elif nextitem in bad_loot_options:
